...
run_cli("-install github.com/pt-main/run-scripts@main/addMit.py 'Write MIT licence in current dir to LICENCE file'")

print_colored("[?YW]    Installing addApcache20...[?RT]\n")
run_cli("-install github.com/pt-main/run-scripts@main/addApache20.py 'Write Apache 2.0 licence in current dir to LICENCE file'")
